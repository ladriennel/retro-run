...
public abstract class MovingThing implements Moveable {
  ...
  /**
   * Constructs a MovingThing object at a specified x and y position with width
   * and height and speed of 10
   * 
  ...
  /**
   * Constructs a MovingThing object with specified position, width and height and
   * speed ADD @param TAGS
   *
   * @param x the specified x
   * @param y the specified y
   * @param w the specified width
   * @param h the specified height
   * @param s the specified speed
   */
